    ...
    <div class="container">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark pt-4 px-0">
            <a class="navbar-brand mr-5" href="#">
                <img src="<?=PATH_URL?>images/app-promo/shards-logo-green.svg" class="mr-2" alt="Shards - Agency Landing Page">
                Shards App
            </a>
        ...
        <div class="row">
            <div class="col-lg-5 col-md-5 col-sm-12 mt-auto mb-auto mr-3">
                ...
                <div class="d-block mt-4">
                    <a href="https://designrevision.com/download/shards"><img class="w-25 mt-2 mr-3" src="<?=PATH_URL?>images/app-promo/badge-apple-store.png" alt="Get it on Apple Store"></a>
                    <a href="https://designrevision.com/download/shards"><img class="w-25 mt-2" src="<?=PATH_URL?>images/app-promo/badge-google-play-store.png" alt="Get it on Google Play Store"></a>
                </div>
            </div>

            <div class="col-lg-4 col-md-5 col-sm-12 ml-auto">
                <img class="iphone-mockup ml-auto" src="<?=PATH_URL?>images/app-promo/iphone-app-mockup.png" alt="iPhone App Mockup - Shards App Promo Demo">
            </div>
        </div>
    </div>
    <!-- / Inner Wrapper -->
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="app-screenshot col-lg-4 col-md-12 col-sm-12 px-0 py-5">
                <img class="mt-auto mb-auto" src="<?=PATH_URL?>images/app-promo/iphone-app-screenshot.png" alt="App Screenshot - Shards App Promo Demo Page">
            </div>
        ...
        <div class="row">
            <div class="col-md-4 testimonial text-center">
                <div class="avatar rounded-circle with-shadows mb-3 ml-auto mr-auto">
                    <img src="<?=PATH_URL?>images/common/avatar-1.jpeg" class="w-100" alt="Testimonial Avatar" />
                </div>
            ...
            <div class="col-md-4 testimonial text-center">
                <div class="avatar rounded-circle with-shadows mb-3 ml-auto mr-auto">
                    <img src="<?=PATH_URL?>images/common/avatar-2.jpeg" class="w-100" alt="Testimonial Avatar" />
                </div>
            ...
            <div class="col-md-4 testimonial text-center">
                <div class="avatar rounded-circle with-shadows mb-3 ml-auto mr-auto">
                    <img src="<?=PATH_URL?>images/common/avatar-3.jpeg" class="w-100" alt="Testimonial Avatar" />
                </div>
            ...
            <div class="row">
                <div class="card-deck">
                    <div class="col-md-12 col-lg-4">
                        <div class="card mb-4">
                            <img class="card-img-top" src="<?=PATH_URL?>images/common/card-1.jpg" alt="Card image cap">
                            <div class="card-body">
                    ...
                    <div class="col-md-12 col-lg-4">
                        <div class="card mb-4">
                            <img class="card-img-top" src="<?=PATH_URL?>images/common/card-3.jpg" alt="Card image cap">
                            <div class="card-body">
                    ...
                    <div class="col-md-12 col-lg-4">
                        <div class="card mb-4">
                            <img class="card-img-top" src="<?=PATH_URL?>images/common/card-2.jpg" alt="Card image cap">
                            <div class="card-body">
